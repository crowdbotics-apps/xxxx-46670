"""
Django settings for xxxx_46670 project.
...
WSGI_APPLICATION = 'xxxx_46670.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "xxxx_46670 API",
    "DESCRIPTION": "API documentation for xxxx_46670 App",
    "VERSION": "v1",
}
